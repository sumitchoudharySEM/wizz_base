              ...
              <div key={index}>
                ...
                <div className={`w-full flex-col space-y-2 p-1 `}>
                  <div className="py-2 flex space-x-2 align-middle justify-between">
                    {/* <Link href={`/profile/${item.creatorAddress}`}>
                      <div className="flex space-x-4 align-middle">
                        <div>
                          <img
                            className="rounded-full h-12 w-12"
                            src={`${NEXT_PUBLIC_GATEWAY_URL}/ipfs/${item.ownerImage}`}
                            alt=""
                          />
                        </div>
                  ...
                  <div className="text-white text-md">{item.content}</div>
                  {item.IPFSImagesRef !== null &&
                  item.IPFSImagesRef !== "" &&
                  item.IPFSImagesRef!== undefined &&
                  item.IPFSImagesRef !== "null" &&
                  item.IPFSImagesRef !== "undefined" &&
                  item.IPFSImagesRef !== " " ? (
                    <img
                      className="h-auto w-full object-cover rounded-2xl"
                      src={`${NEXT_PUBLIC_GATEWAY_URL}/ipfs/${item.IPFSImagesRef}`}
                      alt=""
                    />
                  ) : (
                    <></>
