...
const Sidebar = ({setClicked,setSidebar,isSidebar, userProfile}) => {
  ...
  return (
    ...
    <div className={`lg:fixed lg:w-[23%] md:w-[90%] w-full h-[100vh] py-10 px-6 md:flex ml-5  flex-col justify-between border-r-[#393C49] border-r-4 ${isSidebar==false ? "hidden" : ""}   `}>
      <div className="pb-20">
